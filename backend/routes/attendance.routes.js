...
// Mark attendance
router.post("/", auth, checkRole(["admin", "mentor"]), createAttendance);

// Update attendance
router.put("/:id", auth, checkRole(["admin", "mentor"]), updateAttendance);

// Delete attendance
router.delete("/:id", auth, checkRole(["admin", "mentor"]), deleteAttendance);
